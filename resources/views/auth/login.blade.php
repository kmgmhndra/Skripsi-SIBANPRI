<x-guest-layout>
    ...
    <body class="bg-gradient-to-r from-blue-50 to-blue-100 flex items-center justify-center min-h-screen relative">
        ...
        <div class="hidden md:flex absolute top-4 right-4 space-x-4">
            <img src="{{ asset('images/logo1.png') }}" alt="Logo Pemerintah"
                class="h-12 md:h-16 hover:scale-105 transition-transform duration-300">
            <img src="{{ asset('images/logo2.png') }}" alt="Logo Distan"
                class="h-12 md:h-16 hover:scale-105 transition-transform duration-300">
        </div>
        <!-- Mobile Logo -->
        ...
        <div class="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center px-4">
            <!-- Left Section -->
            <div
                class="w-full md:w-3/5 px-2 md:px-12 py-8 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            ...
            <div
                class="w-full md:w-2/5 px-4 md:px-12 py-8 md:py-10 bg-white shadow-2xl rounded-lg flex flex-col justify-center transform hover:scale-105 transition-transform duration-300 mt-6 md:mt-0">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer"
                                ...
                                <i id="eyeIcon"
                                    class="fas fa-eye text-gray-500 hover:text-blue-600 transition duration-300"></i>
                            </span>
                        </div>
                        @error('password')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-gray-600">Belum punya akun? <a href="{{ route('register') }}"
                                class="text-blue-600 hover:underline font-semibold transition duration-300">Daftar
                                sekarang</a></p>
                    </div>
                </form>
            </div>
