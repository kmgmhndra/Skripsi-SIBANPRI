...
<div class="container mx-auto p-4 sm:p-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div class="text-center md:text-left">
            ...
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Berikut adalah hasil seleksi berdasarkan kecamatan dan tanggal</p>
        </div>
    </div>
    ...
    <div class="mt-6 space-y-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center space-y-2 md:space-y-0">
            <div>
                <h2 class="text-lg sm:text-xl font-semibold text-gray-700">{{ $laporan->nama_laporan }}</h2>
                <p class="text-gray-600 text-sm">Tanggal Seleksi: {{ \Carbon\Carbon::parse($laporan->tanggal_seleksi)->format('d F Y') }}</p>
            </div>

            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full md:w-auto justify-center md:justify-end">
